    ...
    return (
        <section id="skills" className="w-full max-w-4xl py-6 border-t border-white/5">
            <div className="p-4 sm:p-6 md:p-8 rounded-3xl bg-[#111111] border border-white/5 shadow-lg">
                <h2 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-white text-left">Tech Stack</h2>
                <div className="grid grid-cols-3 sm:grid-cols-6 gap-3 sm:gap-4">
                    {skills.map((skill, index) => (
                        <div key={index} className="flex flex-col items-center justify-center gap-2 group cursor-default p-3 sm:p-4 rounded-xl bg-white/5 hover:bg-white/10 transition-all duration-300">
                            <skill.icon className="text-2xl sm:text-3xl text-gray-400 group-hover:text-white transition-colors" />
